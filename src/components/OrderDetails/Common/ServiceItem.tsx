...
const ServiceItem: React.FC<ServiceItemProps> = ({
  ...
  // Make sure we're using the actual quantity for display
  const displayQuantity = totalQuantity > 0 ? totalQuantity : 0;
  ...
  return (
    <View style={styles.serviceCard}>
      ...
      <View style={styles.serviceControls}>
        <View style={styles.serviceControlsRow}>
          <View style={styles.controlGroup}>
            <Text style={styles.controlLabel}>PRINT: <Text style={styles.controlPreview}>({displayQuantity})</Text></Text>
          ...
          <View style={styles.controlGroup}>
            <Text style={styles.controlLabel}>Adjust: <Text style={styles.controlPreview}>({displayQuantity})</Text></Text>
            <View style={styles.counterRow}>
              <TouchableOpacity 
                style={styles.counterButton}
                onPress={() => {
